...
export const productsController = {
    async getAllProducts(req, res, next){
        try{
            const prodsquery = await db.query(
                `
                SELECT product_id, product_name, product_price, product_description, qty_available, in_stock 
    ...
    async createProduct(req, res, next){
        ...
        try{
            ...
            tokki_shop.products(product_name, product_price, product_description, qty_available, in_stock)
            VALUES($1, $2, $3, $4, $5) 
            RETURNING product_id, product_name, product_price, product_description, qty_available, in_stock, is_archived;
            `;
            const values = [product_name, product_price, product_description, qty_available, in_stock];
    ...
    async updateProductDetails (req, res, next) {
        ...
        try{
            ...
            SET product_name = $1, product_price = $2, product_description = $3, qty_available = $4, in_stock = $5
            WHERE product_id = $6
            RETURNING product_id, product_name, product_price, product_description, qty_available, in_stock;
            `
            const values = [updatedName, updatedPrice, updatedDescription, updatedQuantity, updatedStockStatus, productId];
